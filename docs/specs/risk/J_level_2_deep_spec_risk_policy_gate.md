# Level 2 Deep Spec — J（整理のみ / 新規仕様追加なし）

## L2-1. Non-negotiable（固定ルール）カタログ
### L2-1.1 変更は必ずChange Workflowを通す
...
## L2-2. Canonical Model / Contract（SSOT構造の正準）
### L2-2.1 正本と参照SSOT
