...
- [ ] D7: `docs/troubleshooting.md` updated with Mongo-down + spool behavior. `docs/legacy/marketdata_collector_framework_v1_4.md` updated with durability and dedup semantics.
...
- [x] D7: `docs/troubleshooting.md` created. `docs/legacy/marketdata_collector_framework_v1_4.md` created.
