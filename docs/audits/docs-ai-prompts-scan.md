...
docs/rules/parallel-development-safety.md:27:## 3. LOCK policy
docs/rules/parallel-development-safety.md:29:### 3.1 LOCK / semi-LOCK behavior
docs/rules/parallel-development-safety.md:31:- **LOCK area**: only one active PR may touch that area.
docs/rules/parallel-development-safety.md:32:- **Semi-LOCK area**: parallel PRs allowed only with zero file overlap and explicit coordination.
docs/rules/parallel-development-safety.md:43:- shared-docs (`docs/SSOT/**`, `docs/rules/**`, docs hubs/indexes)
docs/rules/parallel-development-safety.md:49:- `Required Locks: docs/SSOT/**`
docs/rules/parallel-development-safety.md:72:- [ ] No overlap in LOCK/semi-LOCK areas
...
docs/SSOT/README_AI.md:8:2. Human-readable status snapshot (non-SSOT): `docs/status/CURRENT_STATUS.md`
docs/SSOT/README_AI.md:9:3. Runtime status SSOT: `docs/status/status.json`
docs/SSOT/README_AI.md:10:4. Tech context hub (non-SSOT links-only): `docs/SSOT/TECH_CONTEXT.md`
docs/SSOT/README_AI.md:11:5. Handoff state: `docs/status/HANDOFF.json`
docs/SSOT/README_AI.md:13:7. Trace SSOT: `docs/status/trace-index.md`
docs/SSOT/README_AI.md:14:8. Rules SSOT:
docs/SSOT/README_AI.md:19:## SSOT boundaries (important)
docs/SSOT/README_AI.md:21:- **Canonical AI entrypoint:** `docs/SSOT/README_AI.md`
docs/SSOT/README_AI.md:22:- **Status SSOT:** `docs/status/status.json`
docs/SSOT/README_AI.md:23:- **`docs/status/CURRENT_STATUS.md` is a summary only (non-SSOT).**
docs/SSOT/README_AI.md:24:- **`docs/SSOT/TECH_CONTEXT.md` is a links hub only (non-SSOT).**
docs/SSOT/README_AI.md:29:- **Stop protocol (Multi-AI / Credit-out):** if stopping, pausing, or handing over, update `docs/status/HANDOFF.json` with `what_done`, `what_next`, `errors`, `commands_next`.
docs/SSOT/README_AI.md:30:- **Single active task:** only one active task is tracked in `docs/status/status.json`.
docs/SSOT/README_AI.md:31:- **Progress claim evidence:** update `docs/status/status.json` or append `docs/status/progress-updates/*` before claiming progress.
docs/SSOT/README_AI.md:32:- **LOCK areas:** lock-sensitive areas include contracts/ci/infra/lockfiles and shared-docs (`docs/SSOT/**`, `docs/rules/**`, docs hubs). Declare `Required Locks` in task cards.
docs/SSOT/README_AI.md:33:- **Trace SSOT:** `docs/status/trace-index.md` is the canonical place for PR/commit/evidence links.
docs/SSOT/TECH_CONTEXT.md:4:It is **not** a full technical SSOT and must not duplicate long specs.
...
docs/audits/docs-rules-unify-decision.md:5:- Chosen approach: **Option A** (`docs/rules/` as rules SSOT namespace).
...
docs/audits/docs-ai-pack-decision.md:8:| Any root-level AI files | None detected | none | avoid | Do not create root-level `AI_READ_ME.md` or equivalent SSOT duplicates. |
...
docs/audits/docs-ai-pack-decision.md:14:- Keep `docs/SSOT/TECH_CONTEXT.md` as a link hub (not a new canonical source of detailed specs).
...
docs/audits/docs-ai-pack-scan.md:114:docs/rules/parallel-development-safety.md:1:# Parallel Development Safety (SSOT)
docs/audits/docs-ai-pack-scan.md:115:docs/rules/parallel-development-safety.md:43:- shared-docs (`docs/SSOT/**`, `docs/rules/**`, docs hubs/indexes)
