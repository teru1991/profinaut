...
docs/SSOT/README_AI.md:7:1. This file: `docs/SSOT/README_AI.md`
docs/SSOT/README_AI.md:8:2. Runtime status: `docs/status/status.json`
docs/SSOT/README_AI.md:9:3. Handoff state: `docs/status/HANDOFF.json`
docs/SSOT/README_AI.md:10:4. Decision baseline: `docs/status/decisions.md`
docs/SSOT/README_AI.md:11:5. Rules SSOT:
docs/SSOT/README_AI.md:17:- **Stop protocol (Multi-AI / Credit-out):** if stopping, pausing, or handing over, update `docs/status/HANDOFF.json` with `what_done`, `what_next`, `errors`, `commands_next`.
docs/SSOT/README_AI.md:18:- **Single active task:** only one active task is tracked in `docs/status/status.json`.
docs/SSOT/README_AI.md:19:- **Progress claim evidence:** update `docs/status/status.json` or append `docs/status/progress-updates/*` before claiming progress.
docs/SSOT/README_AI.md:20:- **LOCK areas:** lock-sensitive areas include contracts/ci/infra/lockfiles and shared-docs (`docs/SSOT/**`, `docs/rules/**`, docs hubs). Declare `Required Locks` in task cards.
docs/SSOT/README_AI.md:21:- **Trace SSOT:** `docs/status/trace-index.md` is the canonical place for PR/commit/evidence links.
docs/SSOT/README_AI.md:22:- **Decisions are binding:** use `docs/status/decisions.md` to fix assumptions and supersede only via explicit new decision entries.
