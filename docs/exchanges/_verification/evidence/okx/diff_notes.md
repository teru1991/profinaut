...
- Auth signature/timestamp/header の公式突合が未確定（実装修正前提）。
  - URL: https://www.okx.com/docs-v5/en/#overview-rest-authentication
- WS keepalive/reconnect/sequence 復元ルールの確定記述が不足。
  - URL: https://www.okx.com/docs-v5/en/#overview-websocket-overview
